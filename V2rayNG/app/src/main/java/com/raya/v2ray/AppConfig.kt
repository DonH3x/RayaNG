...
object AppConfig {
    ...
    const val PREF_PREFER_MASTER_ENABLED = "pref_prefer_master_enabled"
    ...
    /** Broadcast actions. */
    const val BROADCAST_ACTION_SERVICE = "com.raya.ang.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.raya.ang.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "com.raya.ang.action.widget.click"
    ...
    const val APP_URL = "$GITHUB_URL/DonH3x/RayaNG"
    const val APP_API_URL = "https://api.github.com/repos/DonH3x/RayaNG/releases"
    ...
    const val TG_BOT_URL = "https://t.me/RayaVpnRobot"
    ...
    const val RAY_NG_CHANNEL_NAME = "RayaNG Background Service"
