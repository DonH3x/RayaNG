package com.raya.v2ray.util

import android.util.Log
import com.raya.v2ray.AppConfig
import com.raya.v2ray.AppConfig.LOOPBACK
import com.raya.v2ray.BuildConfig
import com.raya.v2ray.util.Utils.encode
import com.raya.v2ray.util.Utils.urlDecode
...
object HttpUtil {
    ...
    fun getUrlContentWithUserAgent(url: String?, timeout: Int = 15000, httpPort: Int = 0): String {
        ...
        while (redirects++ < maxRedirects) {
            ...
            conn.setRequestProperty("User-agent", "Raya2NG/${BuildConfig.VERSION_NAME}")
            conn.connect()
