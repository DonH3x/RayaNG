...
import com.raya.v2ray.extension.toLongEx
import com.raya.v2ray.handler.MmkvManager
import com.raya.v2ray.service.SubscriptionUpdater
import com.raya.v2ray.util.Utils
import com.raya.v2ray.viewmodel.SettingsViewModel
  ...
  class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private fun initSharedPreference() {
      ...
      listOf(
        ...
        AppConfig.PREF_PREFER_MASTER_ENABLED
      ).forEach { key ->
