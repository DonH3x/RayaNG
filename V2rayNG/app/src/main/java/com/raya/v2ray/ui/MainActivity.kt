...
import com.raya.v2ray.AppConfig.VPN
import com.raya.v2ray.R
import com.raya.v2ray.databinding.ActivityMainBinding
...
import com.raya.v2ray.handler.MigrateManager
import com.raya.v2ray.handler.MmkvManager
import com.raya.v2ray.helper.SimpleItemTouchHelperCallback
import com.raya.v2ray.service.V2RayServiceManager
import com.raya.v2ray.util.Utils
import com.raya.v2ray.viewmodel.MainViewModel
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    binding.fabFast.setOnClickListener {
      if (mainViewModel.serversCache.size == 0) {
        toastError(R.string.empty_server_list)
        return@setOnClickListener
      }
        toast(getString(R.string.finding_best_server))
      mainViewModel.selectBestServer()
    }
